...
public class HospitalDemo {
    public static void main(String[] args) {
        ...
        Predicate<Doctor> higherLevel = d -> d.getLevel() >= 7;
        Predicate<Doctor> goodDoctor = morePatients.and(higherLevel);

        Doctor[] passing = er.filter(goodDoctor);
